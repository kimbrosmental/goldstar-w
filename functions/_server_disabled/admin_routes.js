...
// 주물관리 페이지
router.get('/admin/jumool', ipAllowlistMiddleware, sessionMiddleware, adminAuthMiddleware, (req, res) => {
  // TODO: Replace with actual data or render logic
  res.send('주물관리 페이지');
});

// 1:1문의 페이지
router.get('/admin/inquiry', ipAllowlistMiddleware, sessionMiddleware, adminAuthMiddleware, (req, res) => {
  // TODO: Replace with actual data or render logic
  res.send('1:1문의 페이지');
});
